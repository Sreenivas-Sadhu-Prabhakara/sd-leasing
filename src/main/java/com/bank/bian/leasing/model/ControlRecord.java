package com.bank.bian.leasing.model;
...
/**
 * The BIAN control record for this service domain: "Lease Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Lease Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Lease Facility Fulfillment Arrangement";
